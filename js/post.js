$(document).ready(function(){
    ...
    window.disqus_shortname = 'madongsheng'; // required: replace example with your forum shortname
    ...
    $('.entry a').each(function(index,element){
        ...
        if(href){
            if(href.indexOf('#') == 0){
            }else if ( href.indexOf('/') == 0 || href.toLowerCase().indexOf('madongsheng.net')>-1 ){
